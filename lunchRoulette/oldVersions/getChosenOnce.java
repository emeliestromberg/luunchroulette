        ...
        while (playing) {
            ...
            if (playerInput.equals("play")) {
                ...
                while (play) {
                    ...
                    try {
                        BufferedReader br = new BufferedReader(new FileReader(
                                "/Users/emelie.stromberg/Desktop/Coding/VSCode/lunchRoulette/main/textFiles/nameListPlay.txt"));
                        String s;
                    ...
                    for (int i = 0; i < 3; i++) {
                        ...
                        try {
                            BufferedWriter bw = new BufferedWriter(new FileWriter(
                                    "/Users/emelie.stromberg/Desktop/Coding/VSCode/lunchRoulette/main/textFiles/nameListPlay.txt"));
                            for (int j = 0; j < nameListPlay.size(); j++) {
                                String namesLeft = nameListPlay.get(j);
                                bw.write(namesLeft + "\n");
                            }
                            bw.close();
